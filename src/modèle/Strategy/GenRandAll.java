...
public class GenRandAll implements Strategy{
    /**
     ...
     * @return Rempli le plateau avec le nombre de pieces aleatoire indiquée ou moins s'il n'y a plus de place.
     */
    public void initPlateauRand(PlateauPuzzle plateau , int numb , int difficulte){
        ...
        //System.out.println("antiloop: "+antiloop);
        //System.out.println("Ici: "+j);
    }
}